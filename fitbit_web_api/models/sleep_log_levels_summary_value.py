...
class SleepLogLevelsSummaryValue(BaseModel):
    """
    ...
    thirty_day_avg_minutes: Optional[StrictInt] = Field(
        default=None,
        description="The average sleep stage time over the past 30 days.",
        alias="thirtyDayAvgMinutes",
    )
    __properties: ClassVar[List[str]] = ["count", "minutes", "thirtyDayAvgMinutes"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "thirtyDayAvgMinutes": obj.get("thirtyDayAvgMinutes"),
            }
        )
        return _obj
