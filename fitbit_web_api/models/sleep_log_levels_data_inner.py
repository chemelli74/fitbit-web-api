...
class SleepLogLevelsDataInner(BaseModel):
    ...
    level: StrictStr | None = Field(
        default=None, description="The sleep level the user entered."
    )
    seconds: StrictInt | None = Field(
        default=None,
        description="The length of time the user was in the sleep level in seconds.",
    )
    __properties: ClassVar[list[str]] = ["dateTime", "level", "seconds"]
