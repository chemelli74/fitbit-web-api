...
class NutritionTimeSeriesApi:
    ...
    async def get_foods_by_date_range(
        ...
        """  # noqa: E501
        _param = self._get_foods_by_date_range_serialize(
    ...
    @validate_call
    async def get_foods_by_date_range_with_http_info(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def get_foods_by_date_range_without_preload_content(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
    ...
    def _get_foods_by_date_range_serialize(
        self,
        var_resource_path,
        base_date,
        end_date,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/foods/log/{resource-path}/date/{base-date}/{end-date}.json",
    ...
    @validate_call
    async def get_foods_resource_by_date_period(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
        ...
        :return: Returns the result object.
        """  # noqa: E501
        _param = self._get_foods_resource_by_date_period_serialize(
            var_resource_path=var_resource_path,
            var_date=var_date,
            period=period,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def get_foods_resource_by_date_period_with_http_info(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def get_foods_resource_by_date_period_without_preload_content(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
    ...
    def _get_foods_resource_by_date_period_serialize(
        self,
        var_resource_path,
        var_date,
        period,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/foods/log/{resource-path}/date/{date}/{period}.json",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
