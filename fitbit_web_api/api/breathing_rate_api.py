...
class BreathingRateApi:
    ...
    @validate_call
    async def get_breathing_rate_summary_by_date(
        self,
        var_date: Annotated[
        ...
        """  # noqa: E501
        _param = self._get_breathing_rate_summary_by_date_serialize(
            var_date=var_date,
    ...
    @validate_call
    async def get_breathing_rate_summary_by_date_with_http_info(
        self,
        var_date: Annotated[
            date, Field(description="The date in the format of yyyy-MM-dd or today.")
        ],
    ...
    @validate_call
    async def get_breathing_rate_summary_by_date_without_preload_content(
        self,
        var_date: Annotated[
            date, Field(description="The date in the format of yyyy-MM-dd or today.")
        ],
    ...
    def _get_breathing_rate_summary_by_date_serialize(
        self,
        var_date,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/br/date/{date}.json",
    ...
    @validate_call
    async def get_breathing_rate_summary_by_interval(
        self,
        ...
        :return: Returns the result object.
        """  # noqa: E501
        _param = self._get_breathing_rate_summary_by_interval_serialize(
    ...
    @validate_call
    async def get_breathing_rate_summary_by_interval_with_http_info(
        self,
        start_date: Annotated[
            date, Field(description="The date in the format of yyyy-MM-dd or today.")
        ],
    ...
    @validate_call
    async def get_breathing_rate_summary_by_interval_without_preload_content(
        self,
        start_date: Annotated[
            date, Field(description="The date in the format of yyyy-MM-dd or today.")
        ],
    ...
    def _get_breathing_rate_summary_by_interval_serialize(
        self,
        start_date,
        end_date,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/br/date/{startDate}/{endDate}.json",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
