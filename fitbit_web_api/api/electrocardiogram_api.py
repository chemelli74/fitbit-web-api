...
class ElectrocardiogramApi:
    ...
    async def get_ecg_log_list(
        ...
        """  # noqa: E501
        _param = self._get_ecg_log_list_serialize(
            sort=sort,
            offset=offset,
            limit=limit,
    ...
    @validate_call
    async def get_ecg_log_list_with_http_info(
        self,
        sort: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def get_ecg_log_list_without_preload_content(
        self,
        sort: Annotated[
            StrictStr,
            Field(
    ...
    def _get_ecg_log_list_serialize(
        self,
        sort,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/ecg/list.json",
