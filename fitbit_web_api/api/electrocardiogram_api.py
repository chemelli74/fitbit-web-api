...
class ElectrocardiogramApi(object):
    ...
    def get_ecg_log_list(self, sort, offset, limit, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_ecg_log_list_with_http_info(
                sort, offset, limit, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_ecg_log_list_with_http_info(
                sort, offset, limit, **kwargs
            )  # noqa: E501
            return data

    def get_ecg_log_list_with_http_info(
