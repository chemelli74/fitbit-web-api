...
class HeartRateTimeSeriesApi:
    ...
    async def get_heart_by_date_period(
        ...
        """  # noqa: E501
        _param = self._get_heart_by_date_period_serialize(
            var_date=var_date,
            period=period,
    ...
    def _get_heart_by_date_period_serialize(
        self,
        var_date,
        period,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/activities/heart/date/{date}/{period}.json",
    ...
    @validate_call
    async def get_heart_by_date_range(
        self,
        base_date: Annotated[
            StrictStr,
            Field(
        ...
        :return: Returns the result object.
        """  # noqa: E501
        _param = self._get_heart_by_date_range_serialize(
            base_date=base_date,
            end_date=end_date,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_heart_by_date_range_with_http_info(
        self,
        base_date: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def get_heart_by_date_range_without_preload_content(
        self,
        base_date: Annotated[
            StrictStr,
            Field(
    ...
    def _get_heart_by_date_range_serialize(
        self,
        base_date,
        end_date,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/activities/heart/date/{base-date}/{end-date}.json",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
