...
class DefaultApi:
    ...
    @validate_call
    async def call_1_user_profile_json_post(
        self,
        ...
        """
        _param = self._call_1_user_profile_json_post_serialize(
    ...
    @validate_call
    async def call_1_user_profile_json_post_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def call_1_user_profile_json_post_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _call_1_user_profile_json_post_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
