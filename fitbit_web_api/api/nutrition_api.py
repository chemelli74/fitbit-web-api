...
class NutritionApi:
    ...
    async def add_foods(
        ...
        form_type: Annotated[
            StrictStr | None, Field(description="Form type; LIQUID or DRY.")
        ] = None,
        description: Annotated[
            StrictStr | None, Field(description="The description of the food.")
        ] = None,
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[
    ...
    async def add_update_foods_goal(
        ...
        personalized: Annotated[
            StrictStr | None, Field(description="Food plan type; true or false.")
        ] = None,
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[
