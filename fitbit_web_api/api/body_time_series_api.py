...
class BodyTimeSeriesApi:
    ...
    @validate_call
    async def get_body_resource_by_date_period(
        self,
        ...
        """  # noqa: E501
        _param = self._get_body_resource_by_date_period_serialize(
    ...
    @validate_call
    async def get_body_resource_by_date_period_with_http_info(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def get_body_resource_by_date_period_without_preload_content(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
    ...
    def _get_body_resource_by_date_period_serialize(
        self,
        var_resource_path,
        var_date,
        period,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/body/{resource-path}/date/{date}/{period}.json",
    ...
    @validate_call
    async def get_body_resource_by_date_range(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
        ...
        :return: Returns the result object.
        """  # noqa: E501
        _param = self._get_body_resource_by_date_range_serialize(
            var_resource_path=var_resource_path,
            base_date=base_date,
            end_date=end_date,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def get_body_resource_by_date_range_with_http_info(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def get_body_resource_by_date_range_without_preload_content(
        self,
        var_resource_path: Annotated[
            StrictStr,
            Field(
    ...
    def _get_body_resource_by_date_range_serialize(
        self,
        var_resource_path,
        base_date,
        end_date,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/1/user/-/body/{resource-path}/date/{base-date}/{end-date}.json",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
