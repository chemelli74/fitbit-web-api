...
import fitbit_web_api.models
from fitbit_web_api import rest
from fitbit_web_api.api_response import ApiResponse
from fitbit_web_api.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(fitbit_web_api.models, klass)
