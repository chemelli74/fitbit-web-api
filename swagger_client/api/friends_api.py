...
class FriendsApi:
    ...
    def get_friends(self, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.get_friends_with_http_info(**kwargs)
        else:
            (data) = self.get_friends_with_http_info(**kwargs)
            return data

    def get_friends_with_http_info(self, **kwargs):
        """
        Get Friends  # noqa: E501
    ...
    def get_friends_leaderboard(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_friends_leaderboard_with_http_info(**kwargs)
        else:
            (data) = self.get_friends_leaderboard_with_http_info(**kwargs)
            return data

    def get_friends_leaderboard_with_http_info(self, **kwargs):
        """
        Get Friends Leaderboard  # noqa: E501
