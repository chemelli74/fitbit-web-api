...
class AuthorizationApi:
    ...
    def introspect(self, token, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.introspect_with_http_info(token, **kwargs)
        else:
            (data) = self.introspect_with_http_info(token, **kwargs)
            return data

    def introspect_with_http_info(self, token, **kwargs):
        """
        Retrieve the active state of an OAuth 2.0 token  # noqa: E501
    ...
    def oauth_token(self, client_id, grant_type, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.oauth_token_with_http_info(client_id, grant_type, **kwargs)
        else:
            (data) = self.oauth_token_with_http_info(client_id, grant_type, **kwargs)
            return data

    def oauth_token_with_http_info(self, client_id, grant_type, **kwargs):
        """
        Get OAuth 2 access token  # noqa: E501
        ...
        if "expires_in" in params:
            query_params.append(("expires_in", params["expires_in"]))
    ...
    def revoke(self, token, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.revoke_with_http_info(token, **kwargs)
        else:
            (data) = self.revoke_with_http_info(token, **kwargs)
            return data

    def revoke_with_http_info(self, token, **kwargs):
        """
        Revokes consent of the access token or refresh token  # noqa: E501
