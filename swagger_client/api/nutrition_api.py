...
class NutritionApi:
    ...
    def add_favorite_food(self, food_id, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.add_favorite_food_with_http_info(food_id, **kwargs)
        else:
            (data) = self.add_favorite_food_with_http_info(food_id, **kwargs)
            return data

    def add_favorite_food_with_http_info(self, food_id, **kwargs):
        """
        Add Favorite Food  # noqa: E501
        ...
        if "food_id" in params:
            path_params["food-id"] = params["food_id"]
    ...
    def add_foods_with_http_info(
        ...
        **kwargs
        ...
        if "default_serving_size" in params:
            query_params.append(("defaultServingSize", params["default_serving_size"]))
        if "calories" in params:
            query_params.append(("calories", params["calories"]))
        if "form_type" in params:
            query_params.append(("formType", params["form_type"]))
    ...
    def add_foods_log(self, food_id, meal_type_id, unit_id, amount, _date, **kwargs):
        """
        Log Food  # noqa: E501
    ...
    def add_foods_log_with_http_info(
        ...
        query_params = []
        if "food_id" in params:
            query_params.append(("foodId", params["food_id"]))
        if "food_name" in params:
            query_params.append(("foodName", params["food_name"]))
        if "meal_type_id" in params:
            query_params.append(("mealTypeId", params["meal_type_id"]))
        if "unit_id" in params:
            query_params.append(("unitId", params["unit_id"]))
        if "amount" in params:
            query_params.append(("amount", params["amount"]))
        if "_date" in params:
            query_params.append(("date", params["_date"]))
        if "favorite" in params:
            query_params.append(("favorite", params["favorite"]))
        if "brand_name" in params:
            query_params.append(("brandName", params["brand_name"]))
        if "calories" in params:
            query_params.append(("calories", params["calories"]))
    ...
    def add_meal(self, body, **kwargs):
        ...
        :param async_req bool
        :param Meal body: Meal to create (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.add_meal_with_http_info(body, **kwargs)
        else:
            (data) = self.add_meal_with_http_info(body, **kwargs)
            return data

    def add_meal_with_http_info(self, body, **kwargs):
        """
        Create Meal  # noqa: E501
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `add_meal`"
            )
    ...
    def add_update_foods_goal(self, calories, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.add_update_foods_goal_with_http_info(calories, **kwargs)
        else:
            (data) = self.add_update_foods_goal_with_http_info(calories, **kwargs)
            return data

    def add_update_foods_goal_with_http_info(self, calories, **kwargs):
        """
        Update Food Goal  # noqa: E501
        ...
        :return: None
                 ...
                 returns the request thread.
        """
        all_params = ["calories", "intensity", "personalized"]
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        if "intensity" in params:
            query_params.append(("intensity", params["intensity"]))
        if "personalized" in params:
            query_params.append(("personalized", params["personalized"]))
    ...
    def add_update_water_goal(self, target, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.add_update_water_goal_with_http_info(target, **kwargs)
        else:
            (data) = self.add_update_water_goal_with_http_info(target, **kwargs)
            return data

    def add_update_water_goal_with_http_info(self, target, **kwargs):
        """
        Update Water Goal  # noqa: E501
    ...
    def add_water_log(self, _date, amount, **kwargs):
        """
        Log Water  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.add_water_log_with_http_info(_date, amount, **kwargs)
        else:
            (data) = self.add_water_log_with_http_info(_date, amount, **kwargs)
            return data

    def add_water_log_with_http_info(self, _date, amount, **kwargs):
        """
        Log Water  # noqa: E501
    ...
    def delete_favorite_food(self, food_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_favorite_food_with_http_info(food_id, **kwargs)
        else:
            (data) = self.delete_favorite_food_with_http_info(food_id, **kwargs)
            return data

    def delete_favorite_food_with_http_info(self, food_id, **kwargs):
        """
        Delete Favorite Food  # noqa: E501
    ...
    def delete_foods(self, food_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_foods_with_http_info(food_id, **kwargs)
        else:
            (data) = self.delete_foods_with_http_info(food_id, **kwargs)
            return data

    def delete_foods_with_http_info(self, food_id, **kwargs):
        """
        Delete Custom Food  # noqa: E501
    ...
    def delete_foods_log(self, food_log_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_foods_log_with_http_info(food_log_id, **kwargs)
        else:
            (data) = self.delete_foods_log_with_http_info(food_log_id, **kwargs)
            return data

    def delete_foods_log_with_http_info(self, food_log_id, **kwargs):
        """
        Delete Food Log  # noqa: E501
        ...
        if "food_log_id" in params:
            path_params["food-log-id"] = params["food_log_id"]
    ...
    def delete_meal(self, meal_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_meal_with_http_info(meal_id, **kwargs)
        else:
            (data) = self.delete_meal_with_http_info(meal_id, **kwargs)
            return data

    def delete_meal_with_http_info(self, meal_id, **kwargs):
        """
        Delete Meal  # noqa: E501
        ...
        if "meal_id" in params:
            path_params["meal-id"] = params["meal_id"]
    ...
    def delete_water_log(self, water_log_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_water_log_with_http_info(water_log_id, **kwargs)
        else:
            (data) = self.delete_water_log_with_http_info(water_log_id, **kwargs)
            return data

    def delete_water_log_with_http_info(self, water_log_id, **kwargs):
        """
        Delete Water Log  # noqa: E501
        ...
        if "water_log_id" in params:
            path_params["water-log-id"] = params["water_log_id"]
    ...
    def edit_foods_log(self, food_log_id, meal_type_id, unit_id, amount, **kwargs):
        """
    ...
    def edit_foods_log_with_http_info(
        ...
        :return: None
                 ...
                 returns the request thread.
        """
        all_params = ["food_log_id", "meal_type_id", "unit_id", "amount", "calories"]
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
    ...
    def get_favorite_foods(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_favorite_foods_with_http_info(**kwargs)
        else:
            (data) = self.get_favorite_foods_with_http_info(**kwargs)
            return data

    def get_favorite_foods_with_http_info(self, **kwargs):
        """
        Get Favorite Foods  # noqa: E501
    ...
    def get_foods_by_date(self, _date, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_foods_by_date_with_http_info(_date, **kwargs)
        else:
            (data) = self.get_foods_by_date_with_http_info(_date, **kwargs)
            return data

    def get_foods_by_date_with_http_info(self, _date, **kwargs):
        """
        Get Food Logs  # noqa: E501
    ...
    def get_foods_goal(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_foods_goal_with_http_info(**kwargs)
        else:
            (data) = self.get_foods_goal_with_http_info(**kwargs)
            return data

    def get_foods_goal_with_http_info(self, **kwargs):
        """
        Get Food Goals  # noqa: E501
    ...
    def get_foods_info(self, food_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_foods_info_with_http_info(food_id, **kwargs)
        else:
            (data) = self.get_foods_info_with_http_info(food_id, **kwargs)
            return data

    def get_foods_info_with_http_info(self, food_id, **kwargs):
        """
        Get Food  # noqa: E501
    ...
    def get_foods_list(self, query, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_foods_list_with_http_info(query, **kwargs)
        else:
            (data) = self.get_foods_list_with_http_info(query, **kwargs)
            return data

    def get_foods_list_with_http_info(self, query, **kwargs):
        """
        Search Foods  # noqa: E501
    ...
    def get_foods_locales(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_foods_locales_with_http_info(**kwargs)
        else:
            (data) = self.get_foods_locales_with_http_info(**kwargs)
            return data

    def get_foods_locales_with_http_info(self, **kwargs):
        """
        Get Food Locales  # noqa: E501
    ...
    def get_foods_units(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_foods_units_with_http_info(**kwargs)
        else:
            (data) = self.get_foods_units_with_http_info(**kwargs)
            return data

    def get_foods_units_with_http_info(self, **kwargs):
        """
        Get Food Units  # noqa: E501
    ...
    def get_frequent_foods(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_frequent_foods_with_http_info(**kwargs)
        else:
            (data) = self.get_frequent_foods_with_http_info(**kwargs)
            return data

    def get_frequent_foods_with_http_info(self, **kwargs):
        """
        Get Frequent Foods  # noqa: E501
    ...
    def get_meals(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_meals_with_http_info(**kwargs)
        else:
            (data) = self.get_meals_with_http_info(**kwargs)
            return data

    def get_meals_with_http_info(self, **kwargs):
        """
        Get Meals  # noqa: E501
    ...
    def get_recent_foods(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_recent_foods_with_http_info(**kwargs)
        else:
            (data) = self.get_recent_foods_with_http_info(**kwargs)
            return data

    def get_recent_foods_with_http_info(self, **kwargs):
        """
        Get Recent Foods  # noqa: E501
    ...
    def get_water_by_date(self, _date, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_water_by_date_with_http_info(_date, **kwargs)
        else:
            (data) = self.get_water_by_date_with_http_info(_date, **kwargs)
            return data

    def get_water_by_date_with_http_info(self, _date, **kwargs):
        """
        Get Water Logs  # noqa: E501
    ...
    def get_water_goal(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_water_goal_with_http_info(**kwargs)
        else:
            (data) = self.get_water_goal_with_http_info(**kwargs)
            return data

    def get_water_goal_with_http_info(self, **kwargs):
        """
        Get Water Goal  # noqa: E501
    ...
    def update_meal(self, body, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_meal_with_http_info(body, **kwargs)
        else:
            (data) = self.update_meal_with_http_info(body, **kwargs)
            return data

    def update_meal_with_http_info(self, body, **kwargs):
        """
        Update Meal  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_meal_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `update_meal`"
            )
    ...
    def update_water_log(self, water_log_id, amount, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_water_log_with_http_info(water_log_id, amount, **kwargs)
        else:
    ...
    def update_water_log_with_http_info(self, water_log_id, amount, **kwargs):
        """
        Update Water Log  # noqa: E501
        ...
        :return: None
                 ...
                 returns the request thread.
        """
        all_params = ["water_log_id", "amount", "unit"]
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
