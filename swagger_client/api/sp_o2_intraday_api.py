...
class SpO2IntradayApi:
    ...
    def get_sp_o2_intraday_by_date(self, _date, **kwargs):
        """
        ...
        if kwargs.get("async_req"):
            return self.get_sp_o2_intraday_by_date_with_http_info(_date, **kwargs)
        else:
            (data) = self.get_sp_o2_intraday_by_date_with_http_info(_date, **kwargs)
            return data

    def get_sp_o2_intraday_by_date_with_http_info(self, _date, **kwargs):
        """
        Get SpO2 Intraday by Date  # noqa: E501
    ...
    def get_sp_o2_intraday_by_interval(self, start_date, end_date, **kwargs):
        """
