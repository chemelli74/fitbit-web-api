...
class SleepApi:
    ...
    def add_sleep(self, start_time, duration, _date, **kwargs):
        """
        Log Sleep  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.add_sleep_with_http_info(start_time, duration, _date, **kwargs)
        else:
    ...
    def add_sleep_with_http_info(self, start_time, duration, _date, **kwargs):
        """
        Log Sleep  # noqa: E501
        ...
        :return: None
                 ...
                 returns the request thread.
        """
        all_params = ["start_time", "duration", "_date"]
    ...
    def delete_sleep(self, log_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_sleep_with_http_info(log_id, **kwargs)
        else:
            (data) = self.delete_sleep_with_http_info(log_id, **kwargs)
            return data

    def delete_sleep_with_http_info(self, log_id, **kwargs):
        """
        Delete Sleep Log  # noqa: E501
    ...
    def get_sleep_by_date(self, _date, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_sleep_by_date_with_http_info(_date, **kwargs)
        else:
            (data) = self.get_sleep_by_date_with_http_info(_date, **kwargs)
            return data

    def get_sleep_by_date_with_http_info(self, _date, **kwargs):
        """
        Get Sleep Log  # noqa: E501
    ...
    def get_sleep_by_date_range_with_http_info(self, base_date, end_date, **kwargs):
        """
        Get Sleep Logs by Date Range  # noqa: E501
    ...
    def get_sleep_goal(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_sleep_goal_with_http_info(**kwargs)
        else:
            (data) = self.get_sleep_goal_with_http_info(**kwargs)
            return data

    def get_sleep_goal_with_http_info(self, **kwargs):
        """
        Get Sleep Goal  # noqa: E501
    ...
    def get_sleep_list(self, sort, offset, limit, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_sleep_list_with_http_info(sort, offset, limit, **kwargs)
        else:
            (data) = self.get_sleep_list_with_http_info(sort, offset, limit, **kwargs)
            return data

    def get_sleep_list_with_http_info(self, sort, offset, limit, **kwargs):
        """
        Get Sleep Logs List  # noqa: E501
    ...
    def update_sleep_goal(self, min_duration, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_sleep_goal_with_http_info(min_duration, **kwargs)
        else:
            (data) = self.update_sleep_goal_with_http_info(min_duration, **kwargs)
            return data

    def update_sleep_goal_with_http_info(self, min_duration, **kwargs):
        """
        Update Sleep Goal  # noqa: E501
        ...
        if "min_duration" in params:
            query_params.append(("minDuration", params["min_duration"]))
