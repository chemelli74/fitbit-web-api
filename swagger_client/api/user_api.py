...
class UserApi:
    ...
    def get_badges(self, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.get_badges_with_http_info(**kwargs)
        else:
            (data) = self.get_badges_with_http_info(**kwargs)
            return data

    def get_badges_with_http_info(self, **kwargs):
        """
        Get Badges  # noqa: E501
    ...
    def get_profile(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_profile_with_http_info(**kwargs)
        else:
            (data) = self.get_profile_with_http_info(**kwargs)
            return data

    def get_profile_with_http_info(self, **kwargs):
        """
        Get Profile  # noqa: E501
    ...
    def update_profile_with_http_info(self, **kwargs):
        ...
        if "birthday" in params:
            form_params.append(("birthday", params["birthday"]))
        if "height" in params:
            form_params.append(("height", params["height"]))
        if "about_me" in params:
            form_params.append(("aboutMe", params["about_me"]))
        if "fullname" in params:
            form_params.append(("fullname", params["fullname"]))
        ...
        if "stride_length_walking" in params:
            form_params.append(("strideLengthWalking", params["stride_length_walking"]))
        if "stride_length_running" in params:
            form_params.append(("strideLengthRunning", params["stride_length_running"]))
        if "weight_unit" in params:
            form_params.append(("weightUnit", params["weight_unit"]))
        if "height_unit" in params:
            form_params.append(("heightUnit", params["height_unit"]))
        if "water_unit" in params:
            form_params.append(("waterUnit", params["water_unit"]))
        if "glucose_unit" in params:
            form_params.append(("glucoseUnit", params["glucose_unit"]))
        if "timezone" in params:
            form_params.append(("timezone", params["timezone"]))
        if "foods_locale" in params:
            form_params.append(("foodsLocale", params["foods_locale"]))
        if "locale" in params:
            form_params.append(("locale", params["locale"]))
        if "locale_lang" in params:
            form_params.append(("localeLang", params["locale_lang"]))
        if "locale_country" in params:
            form_params.append(("localeCountry", params["locale_country"]))
        if "start_day_of_week" in params:
            form_params.append(("startDayOfWeek", params["start_day_of_week"]))
