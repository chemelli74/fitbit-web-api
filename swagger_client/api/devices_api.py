...
class DevicesApi:
    ...
    def add_alarms_with_http_info(
        ...
        :return: None
                 ...
                 returns the request thread.
        """
        all_params = ["tracker_id", "time", "enabled", "recurring", "week_days"]
        ...
        if "tracker_id" in params:
            path_params["tracker-id"] = params["tracker_id"]
        ...
        if "recurring" in params:
            query_params.append(("recurring", params["recurring"]))
        if "week_days" in params:
            query_params.append(("weekDays", params["week_days"]))
    ...
    def delete_alarms(self, tracker_id, alarm_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_alarms_with_http_info(tracker_id, alarm_id, **kwargs)
        else:
            (data) = self.delete_alarms_with_http_info(tracker_id, alarm_id, **kwargs)
            return data

    def delete_alarms_with_http_info(self, tracker_id, alarm_id, **kwargs):
        """
        Delete Alarm  # noqa: E501
        ...
        :return: None
                 ...
                 returns the request thread.
        """
        all_params = ["tracker_id", "alarm_id"]
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        if "alarm_id" in params:
            path_params["alarm-id"] = params["alarm_id"]
    ...
    def get_alarms(self, tracker_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_alarms_with_http_info(tracker_id, **kwargs)
        else:
            (data) = self.get_alarms_with_http_info(tracker_id, **kwargs)
            return data

    def get_alarms_with_http_info(self, tracker_id, **kwargs):
        """
        Get Alarms  # noqa: E501
    ...
    def update_alarms_with_http_info(
        ...
        **kwargs
        ...
        if "snooze_length" in params:
            query_params.append(("snoozeLength", params["snooze_length"]))
        if "snooze_count" in params:
            query_params.append(("snoozeCount", params["snooze_count"]))
