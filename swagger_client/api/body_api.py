...
class BodyApi:
    ...
    def add_body_fat_log(self, fat, _date, time, **kwargs):
        """
        ...
        if kwargs.get("async_req"):
            return self.add_body_fat_log_with_http_info(fat, _date, time, **kwargs)
        else:
            (data) = self.add_body_fat_log_with_http_info(fat, _date, time, **kwargs)
            return data

    def add_body_fat_log_with_http_info(self, fat, _date, time, **kwargs):
        """
        Log Body Fat  # noqa: E501
        ...
        query_params = []
        if "fat" in params:
            query_params.append(("fat", params["fat"]))
        if "_date" in params:
    ...
    def add_weight_log(self, weight, _date, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.add_weight_log_with_http_info(weight, _date, **kwargs)
        else:
            (data) = self.add_weight_log_with_http_info(weight, _date, **kwargs)
            return data

    def add_weight_log_with_http_info(self, weight, _date, **kwargs):
        """
        Log Weight  # noqa: E501
        ...
        query_params = []
        if "weight" in params:
            query_params.append(("weight", params["weight"]))
        if "_date" in params:
            query_params.append(("date", params["_date"]))
        if "time" in params:
            query_params.append(("time", params["time"]))
    ...
    def delete_body_fat_log(self, body_fat_log_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_body_fat_log_with_http_info(body_fat_log_id, **kwargs)
        else:
            (data) = self.delete_body_fat_log_with_http_info(body_fat_log_id, **kwargs)
            return data

    def delete_body_fat_log_with_http_info(self, body_fat_log_id, **kwargs):
        """
        Delete Body Fat Log  # noqa: E501
        ...
        if "body_fat_log_id" in params:
            path_params["body-fat-log-id"] = params["body_fat_log_id"]
    ...
    def delete_weight_log(self, body_weight_log_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_weight_log_with_http_info(body_weight_log_id, **kwargs)
        else:
            (data) = self.delete_weight_log_with_http_info(body_weight_log_id, **kwargs)
            return data

    def delete_weight_log_with_http_info(self, body_weight_log_id, **kwargs):
        """
        Delete Weight Log  # noqa: E501
        ...
        if "body_weight_log_id" in params:
            path_params["body-weight-log-id"] = params["body_weight_log_id"]
    ...
    def get_body_fat_by_date(self, _date, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_body_fat_by_date_with_http_info(_date, **kwargs)
        else:
            (data) = self.get_body_fat_by_date_with_http_info(_date, **kwargs)
            return data

    def get_body_fat_by_date_with_http_info(self, _date, **kwargs):
        """
        Get Body Fat Logs  # noqa: E501
    ...
    def get_body_fat_by_date_period(self, _date, period, **kwargs):
        """
        Get Body Fat Logs  # noqa: E501
    ...
    def get_body_fat_by_date_period_with_http_info(self, _date, period, **kwargs):
        """
        Get Body Fat Logs  # noqa: E501
    ...
    def get_body_fat_by_date_range_with_http_info(self, base_date, end_date, **kwargs):
        """
        Get Body Fat Logs  # noqa: E501
    ...
    def get_body_goals(self, goal_type, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_body_goals_with_http_info(goal_type, **kwargs)
        else:
            (data) = self.get_body_goals_with_http_info(goal_type, **kwargs)
            return data

    def get_body_goals_with_http_info(self, goal_type, **kwargs):
        """
        Get Body Goals  # noqa: E501
        ...
        if "goal_type" in params:
            path_params["goal-type"] = params["goal_type"]
    ...
    def get_weight_by_date(self, _date, **kwargs):
        """
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_weight_by_date_with_http_info(_date, **kwargs)
        else:
            (data) = self.get_weight_by_date_with_http_info(_date, **kwargs)
            return data

    def get_weight_by_date_with_http_info(self, _date, **kwargs):
        """
        Get Weight Logs  # noqa: E501
    ...
    def get_weight_by_date_period(self, _date, period, **kwargs):
        """
        Get Body Fat Logs  # noqa: E501
    ...
    def get_weight_by_date_period_with_http_info(self, _date, period, **kwargs):
        """
        Get Body Fat Logs  # noqa: E501
    ...
    def get_weight_by_date_range_with_http_info(self, base_date, end_date, **kwargs):
        """
        Get Body Fat Logs  # noqa: E501
    ...
    def update_body_fat_goal(self, fat, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_body_fat_goal_with_http_info(fat, **kwargs)
        else:
            (data) = self.update_body_fat_goal_with_http_info(fat, **kwargs)
            return data

    def update_body_fat_goal_with_http_info(self, fat, **kwargs):
        """
        Update Body Fat Goal  # noqa: E501
    ...
    def update_weight_goal(self, start_date, start_weight, **kwargs):
        """
    ...
    def update_weight_goal_with_http_info(self, start_date, start_weight, **kwargs):
        """
        Update Weight Goal  # noqa: E501
        ...
        :return: None
                 ...
                 returns the request thread.
        """
        all_params = ["start_date", "start_weight", "weight"]
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        if "start_weight" in params:
            query_params.append(("startWeight", params["start_weight"]))
        if "weight" in params:
            query_params.append(("weight", params["weight"]))
