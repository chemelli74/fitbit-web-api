...
class SubscriptionsApi:
    ...
    def add_subscriptions_with_http_info(
        ...
        :return: None
                 ...
                 returns the request thread.
        """
        all_params = ["collection_path", "subscription_id"]
        ...
        if "collection_path" in params:
            path_params["collection-path"] = params["collection_path"]
    ...
    def get_subscriptions_list(self, collection_path, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_subscriptions_list_with_http_info(collection_path, **kwargs)
        else:
    ...
    def get_subscriptions_list_with_http_info(self, collection_path, **kwargs):
        """
        Get a List of Subscriptions  # noqa: E501
