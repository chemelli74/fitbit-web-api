...
fitbit-web-api could always use more documentation, whether as part of the official fitbit-web-api docs, in docstrings, or even on the web in blog posts, articles, and such.
