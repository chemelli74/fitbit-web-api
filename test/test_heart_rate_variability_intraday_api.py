...
class TestHeartRateVariabilityIntradayApi(unittest.IsolatedAsyncioTestCase):
    """HeartRateVariabilityIntradayApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = HeartRateVariabilityIntradayApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_get_hrv_intraday_by_date(self) -> None:
        """
    ...
    async def test_get_hrv_intraday_by_interval(self) -> None:
        """
